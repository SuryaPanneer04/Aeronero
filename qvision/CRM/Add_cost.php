...
$id = $_REQUEST['id'];
$stmt = $con->query("SELECT a.id as enquiry_id,a.status as enquiry_status,a.email as enquiry_mailid,a.client_org as Company_name,a.*,b.*,c.*,d.*  FROM `crm_calls` a
INNER JOIN calls_master b ON a.Call_type=b.id
INNER join z_department_master c ON a.Department=c.id
INNER JOIN candidate_form_details d ON a.employee=d.id
where a.id='106'");
echo "SELECT a.id as enquiry_id,a.status as enquiry_status,a.email as enquiry_mailid,a.client_org as Company_name,a.*,b.*,c.*,d.*  FROM `crm_calls` a
INNER JOIN calls_master b ON a.Call_type=b.id
INNER join z_department_master c ON a.Department=c.id
INNER JOIN candidate_form_details d ON a.employee=d.id
where a.id='$id'";
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="5"> <select id="emp_id" name="emp_id" class="form-control">
                                ...
                                <?php
                                $query = $con->query("SELECT * FROM staff_master");
                   ...
                   <tr>
                        ...
                        <td colspan="5">
                            ...
                            <textarea id="scope" name="scope" class="form-control" style="height:168px">
                            </textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            ...
                            <textarea id="Conditions" name="Conditions" class="form-control" style="height:168px">
                                    ...
                                    <td><b>Amount<b></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($rows_1 = $sql_1->fetch(PDO::FETCH_ASSOC)) { 
                                                       ...
                                                       <td colspan="1"><input type="text" class="form-control" id="unit" name="unit" value="DOLLER" readonly></td>
                                                ...
                                                <?php if ($sqlquery_1row['Phases'] == 1 && $sqlquery_1row['amount_type'] == 1) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><center>IGST</center></td><td colspan="1"><input type="text" class="form-control" id="GST" name="GST" value="28%" readonly></td>
                                                    </tr>
                                    ...
                                    <td><b>Amount<b></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($rows_1 = $sql_1->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        <td colspan="1"><input type="text" class="form-control" id="Task" name="Task" value="<?php echo $rows_1['Specification']; ?>" readonly></td>
                                                        <td colspan="1"><input type="text" class="form-control" id="unit" name="unit" value="<?php echo $rows_1['day']; ?>" readonly></td>
                                                       <td colspan="1"><input type="text" class="form-control" id="unit" name="unit" value="INR" readonly></td>
														<td colspan="1"><input type="text" class="form-control" id="amt" name="amt" value="<?php echo $rows_1['Amount']; ?>" readonly></td>
                                                        </tr>
                                                    <?php } } ?>
                                                    <?php
		...
		?>
                                                                                                                                                                        ...
                                                                                                                                                                        <TD>
                                                                                                                                                                            <INPUT type="text" id="cost_1" name="cost[]"  class="form-control"> </TD>
																																											   <TD>
                                                                                                                                                                            <select class="form-control" id="quote_type" name="quote_type" required>
                                                                                                                                                        ...
                                                                                                                                                        <?php if ($row['enquiry_status'] == 3 && $row['flag'] == 1 ) {
                                                                                                                                                            ?>
   <center>                                                                                                                                                         <input type="button" class="btn btn-success" id="save" name="save" onclick="cost_update()" value="Generate Cost">
        </center>                                                                                                                                                    <br>
                                                                                                                                                            <br>
                                                                                                                                                            <?php
                                                                                                                                                        }
                                                                                                                                                        ...
                                                                                                                                                        <?php if ($row['enquiry_status'] == 3 && $row['flag'] == 2) {
                                                                                                                                                            ?> 
        <center>                                                                                                                                                    <input type="button" class="btn btn-primary" id="save" name="save" onclick="cost_approval()" value="Generate For Cost Approval">
</center>
                                                                                                                                                            <?php
                                                                                                                                                        }
                                                                                                                                                        ?>

                                                                                                                                                        <?php if ($row['enquiry_status'] == 4 && $userrole == 'R001' || $userrole == 'R002' || $userrole == 'R007') {
                                                                                                                                                            ?>
                                                                                                                                                            <center>
...
$("#quote_type").change(function(e){
	...
	$.ajax({
		...
		url:'BusinessProcess/quotation/getbank_details.php',
		dataType: 'json',
				...
				$('#ifsc_code').val(element.ifsc_code);
                                                                                                                           ...
                                                                                                                           url: 'CRM/cost_update1.php',
                                                                                                                                                                    success: function (data)
                                                                                                                                                                    {
                                                                                                                                                                        ...
                                                                                                                                                                        {
                                            alert("Cost Generated Sucessfully");                                                                                                                              // alert("Cost Generated Sucessfully");
                                                                                                                                                                cost()
                                                                                                                                                                        }
                                                                                                                                                                    }
                                                                                                                                                                });
                                                                                                                                                            ...
                                                                                                                                                            function generate_quotation()
                                                                                                                                                            {
                                                                                                                                                                ...
                                                                                                                                                                $.ajax({
                                                                                                                                                                    ...
                                                                                                                                                                    url:'CRM/generate_quotation.php',
                                                                                                                                                                    success: function (data)
                                                                                                                                                                    {
                                                                                                                                                                        if (data == 1)
                                                                                                                                                                        {
																																							...
																																							<script>
                                                                                                                                                              ...
                                                                                                                                                              $(document).ready(function () {
                                                                                                                                                                $('#emp_id').on('change', function () {
                                                                                                                                                                   ...
                                                                                                                                                                   // alert(emp_id);
                                                                                                                                                                    $.ajax({
                                                                                                                                                                        url: "BusinessProcess/quotation/getemp_details.php",
                                                                                                                                                                        type: "get",
                                                                                                                                                                        data: {
                                                                                                                                                                            emp_id: emp_id
                                                                                                                                                                        },
