...
.card-primary:not(.card-outline)>.card-header{
	...
	<form method="GET" name="hsn_reports" role="form">
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="hsnmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="hsn_empview()">
		</div>
		</div>
...
function hsn_empview()
{
	var data = $('form').serialize();
	$.ajax({
	type: "GET",
	url: "/ssinfo1/qvision/reports/hsn_reports/hsn_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#hsn_details_view").html(data);		
	}				
	});	
}
</script>