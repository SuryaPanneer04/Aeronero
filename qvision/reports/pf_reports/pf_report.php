...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="pfmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="pf_empview()">
		</div>
		</div>
...
function pf_view()
{
	...
	$.ajax({
	type: "GET",
	url: "qvision/reports/pf_reports/pf_report_view.php",
	data: data,
	success: function(data)
	{
	$("#pf_details_view").html(data);		
	}				
	});	
}
...
function pf_empview()
{
	...
	$.ajax({
	type: "GET",
	url: "qvision/reports/pf_reports/pf_reports_employee.php",
	data: data,
	success: function(data)
	{
	$("#pf_details_view").html(data);		
