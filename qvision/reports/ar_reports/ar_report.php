...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="armonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="ar_empview()">
		</div>
		</div>
...
function ar_empview()
{
	...
	$.ajax({
	type: "GET",
	url: "qvisionnew/qvision/reports/ar_reports/ar_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#ar_details_view").html(data);		
	}				
	});	
}
</script>