...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
 ...
 <?php
	...
	{
	?>
	<input type="button" class="btn btn-success" id="save" name="save"  onclick='update_leave("<?php echo $id;?>","<?php echo $leave_reason;?>","<?php echo $candid_id;?>")'  value="Approve">
	<input type="button" class="btn btn-danger" id="submit" name="submit"  onclick='reject_leave("<?php echo $id;?>","<?php echo $leave_reason;?>")'  value="Reject">
	<?php
	}
...
//alert(leave)
	...
	url:"qvision/Leave_Management/permission/permission_approve_update.php",
...
function reject_leave(status,leave)
{
	...
	url:"qvision/Leave_Management/permission/permission_reject_update.php",
	success:function(data)
	{     
    if(data==0)	{
