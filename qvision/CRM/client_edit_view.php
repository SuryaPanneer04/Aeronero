...
<form method="POST" name="form" id="form" action="" >
		...
		<input type="hidden" id="clientidd" name="clientidd" value="<?php echo $sel_qry['client_id'] ; ?>">
		<input type="hidden" id="enquiry_id" name="enquiry_id" value="<?php echo $sel_qry['enquiry_id'] ; ?>">
...
<tr>
   ...
   <td>Website </td>
   <td colspan="5"><input type="text" class="form-control" value="<?php echo $sel_qry['website']; ?>" id="txt_website" name="txt_website" ></td>
   <input type="hidden" value="<?php echo $cusid;?>" name="cus_id" id="cus_id" >
			...
			<td colspan="5"><input type="text" class="form-control" value="<?php echo $sel_qry['location']; ?>" id="Location" name="Location" placeholder="Enter Plant Location" ></td>
			<tr>
				<td>State *</td>
				<td colspan="5">
				<?php
			...
			<tr id="txt_gst_noo">
				<td>GST NO</td>
				<td colspan="5"><input type="text" class="form-control gst form-control mandatory" id="txt_gst_no" name="txt_gst_no"  maxlength="15" value="<?php echo $sel_qry['gst_no']; ?>" ></td>
			...
			<tr>
				...
				<td colspan="5"><input type="text" class="form-control" value="<?php echo $sel_qry['address']; ?>" id="txt_address_1" name="txt_address_1" placeholder =" Enter The Address" ></td>
			</tr>
			

		<tr>
		   <td>Mobile No1 * </td>
		   <td colspan="3"><input type="text" class="form-control" id="txt_mobile1" value="<?php echo $sel_qry['mobile1']; ?>" name="txt_mobile1" maxlength="10" required placeholder="Mobile No1" ></td>
		...
		<tr>
		   <td>Email Id 1 *</td>
		   <td colspan="3"><input type="text" class="form-control" value="<?php echo $sel_qry['email1']; ?>" id="txt_mail_id1" name="txt_mail_id1" required placeholder="Email Id 1" ></td>
...

{
		...
		?>
<tr>
<input type="hidden" class="form-control" id="get_id" name="get_id" value="<?php echo  $rows['calls_id']; ?>" readonly>
<td>Feedback</td>
...
<script>
	...
	url:'qvision/CRM/editvalue_insert.php?enquiry_id='+enquiry_id+'&clientidd='+id,
 ...
 //$('.wage_content').html('<br><div style="text-align: center;"><img src="qvision/images/images/load3.gif"></div>');
    ...
    url:'qvision/CRM/change_status.php?id='+id,
    success:function(data)
    {
