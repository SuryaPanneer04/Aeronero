...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="col-lg-12">
	<h4>EXEMPTED REPORT</h4>
	</div>
    <div class="panel-body">
	<form method="GET" name="exemp_reports" role="form">
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="exempmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="exemp_empview()">
		</div>
		</div>
...
function exemp_empview()
{
	var data = $('form').serialize();
	$.ajax({
	type: "GET",
	url: "/ssinfo1/qvision/reports/exemp_reports/exemp_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#exemp_details_view").html(data);		
	}				
	});	
}
</script>