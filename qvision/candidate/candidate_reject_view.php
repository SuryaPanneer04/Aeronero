...
require '../../connect.php';
$cid=$_REQUEST['id'];
$sql=$con->query("select c.status as candidate_status,cm.*,c.*,d.*,dm.* from candidate_form_details c left join company_master cm on c.company_name=cm.id join jobdescription_master d on c.position=d.id join z_department_master dm on c.department=dm.id where c.id='$cid' order by c.id desc limit 1");
$fet=$sql->fetch();
?>
<style>
   ...
   <form method="POST" enctype="multipart/form-data">
    ...
    <table class="table table-bordered">
       ...
       <tr>
		...
		<tr>
		<td>Resume:<td>
		<td><a href="/ssinfo1/qvision/candidate/uploads/<?php echo $fet['resume'];?>" download="<?php echo $fet['resume']; ?>"><?php echo $fet['resume']; ?></a></td>
		</tr>
...
<tr>
<td>Remarks</td>
<td colspan="2"><input type="text" class="form-control" id="reject_remark" name="reject_remark" value="<?php echo $fet['reject_remark'];?>" readonly></td>
</tr>
