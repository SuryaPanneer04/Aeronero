...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="col-lg-12">
	<h4>Advance Received REPORT</h4>
	</div>
    <div class="panel-body">
	<form method="GET" name="adadj_reports" role="form">
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="adadjmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="adadj_empview()">
		</div>
		</div>
...
function adadj_empview()
{
	var data = $('form').serialize();
	$.ajax({
	type: "GET",
	url: "/ssinfo1/qvision/reports/adadj_reports/adadj_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#adadj_details_view").html(data);		
	}				
	});	
}
</script>