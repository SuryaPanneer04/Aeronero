...
?>
    ...
    <thead>
	  ...
	  $candid_id=$_SESSION['candidateid'];
	    $holiday = $con->query("SELECT a.candidate_id as candidate_id,b.emp_code as emp_code,b.emp_name as emp_name,a.date as date,a.customer_name as customer_name,a.location as c_loc,a.purpose as purpose,a.id as mid,a.location as c_loc,a.status as status FROM claim_request a JOIN staff_master b on a.candidate_id=b.candid_id where a.status='6'");
