...
<div  class="card card-primary">
   ...
   <form method="POST" enctype="multipart/form-data">
    ...
    <table class="table table-bordered">
		...
		<tr>
		  <td colspan="6" align="center"><b>GST Persentage <?php echo $cfet['gst_per']; ?>%</b></td>
		  <td colspan="6" align="right">
		...
		<tr>
		  <td colspan="6" align="center"><b>IGST Persentage <?php echo $cfet['igst_per']; ?>%</b></td>
		  <td colspan="6" align="right">
	 ...
	 if($mdstatus=='0' and $serstatus=='0' and $finstatus=='0' and $marstatus=='0')
	 {
		 ?>
		 <tr>  
...
function submit_po(v)
{
	...
	$.ajax({
		...
		url:"qvision/BusinessProcess/po_approval/marketing_po_reject.php?id="+v+"&remark="+remark,
