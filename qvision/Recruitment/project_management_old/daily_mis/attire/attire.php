							...
							<tr>
								...
								<td colspan="3">
									<select class="form-control" id="Department" name="Department" >
										...
										$stmt = $con->query("SELECT * FROM z_department_master where id!='1'and  id!='6'");
...
//alert(data);
    ...
    type:'GET',
    data: data + "&" + "id="+id,
    url:"qvision/Recruitment/project_management/daily_mis/attire/attire_submit.php",	
...
//alert(department_id);
            $.ajax({
                url: "qvision/Recruitment/project_management/daily_mis/attire/get_designation.php",
	...
	<script>
	  ...
	  // alert(Department)
            ...
            $.ajax({
                url: "qvision/Recruitment/project_management/daily_mis/attire/find_emp.php",
                type: "GET",
                data: {
	 ...
	 $(document).ready(function () {
      ...
      $.ajax({
            type: "POST",
            url: "qvision/Recruitment/project_management/daily_mis/attire/submit.php?id="+Employee+"&date="+datetimepicker1,
            success: function (data) {
                 $("#save").html(data);
            }
        })
