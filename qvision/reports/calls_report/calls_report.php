...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="row">	
		...
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="SEARCH" onclick="callsview()">
		</div>
		</div>
...
function callsview()
{
	...
	$.ajax({
	type: "GET",
	url: "qvision/reports/calls_report/calls.php",
	data: data,
	success: function(data)
	{
	$("#calls_report_view").html(data);		
	}				
	});	
}
</script>