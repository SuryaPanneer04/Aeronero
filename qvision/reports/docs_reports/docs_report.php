...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="col-lg-12">
	<h4>DOCUMENTS REPORT</h4>
	</div>
    <div class="panel-body">
	<form method="GET" name="docs_reports" role="form">
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="docsmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="docs_empview()">
		</div>
		</div>
...
function docs_empview()
{
	var data = $('form').serialize();
	$.ajax({
	type: "GET",
	url: "/ssinfo1/qvision/reports/docs_reports/docs_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#docs_details_view").html(data);		
	}				
	});	
}
</script>