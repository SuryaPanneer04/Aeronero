...
<div class="tab-content">
   ...
   <table class="table table-bordered">
        ...
        <tr>
        <td colspan="6"><center><b>Edit Vendor</b></center></td>
        </tr>
        ...
        <td colspan="2"><input type="text" class="form-control" placeholder="Enter Vendor GSTIN/UN" id="gst_number" name="gst_number" value="<?php echo $row['gst'];?>"></td>
		<td colspan="2"><input type="text" class="form-control" id="phoneno" name="phoneno" placeholder ="Contact" value="<?php echo $row['contact'];?>"></td>
        ...
        <td colspan="6"><input type="button" class="btn btn-dark" name="save" onclick="update_vendor()" value="Update" style="float:right;"></td>
        </tr>
        </table>
        <!-- /.post -->
    </form>
...
//alert(data);
    ...
    type:'GET',
    data: data + "&" + "id="+id,
     url:"qvision/BusinessProcess/doller_vendor_master/vendor_update.php",
