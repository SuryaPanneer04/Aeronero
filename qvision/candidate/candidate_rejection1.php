...
require '../../connect.php';
$cid=$_REQUEST['id'];
$sql=$con->query("select c.status as candidate_status,cm.*,c.*,d.*,dm.* from candidate_form_details c left join company_master cm on c.company_name=cm.id join designation_master d on c.position=d.id join z_department_master dm on c.department=dm.id where c.id='$cid' order by c.id desc limit 1");
$fet=$sql->fetch();
?>
<style>
    ...
    <table class="table table-bordered">
	  ...
	  <td colspan="2"> 
       ...
       <tr>
		...
		<tr>
		<td>Photo:</td>
		<td colspan="4"><a href="/ssinfo1/qvision/candidate/photo/<?php echo $fet['photo'];?>" download="<?php echo $fet['photo']; ?>"><?php echo $fet['photo']; ?></a></td>
		</tr>
		<tr>
		<td>Resume:</td>
		<td colspan="4"><a href="/ssinfo1/qvision/candidate/uploads/<?php echo $fet['resume'];?>" download="<?php echo $fet['resume']; ?>"><?php echo $fet['resume']; ?></a></td>
		</tr>
...
< ?php if($fet['candidate_status']=='5' ||$fet['candidate_status']=='13' ||$fet['candidate_status']=='16' ||$fet['candidate_status']=='19'){
	?>
...
<!--?php if($fet['candidate_status']==35 || $fet['candidate_status']==5 || $fet['candidate_status']==16 || $fet['candidate_status']==19 ) { 
  //HR Feedback ?> 
 <table class="table table-bordered">
...
<tr>
<td>Remarks</td>
<td colspan="2"><textarea class="form-control" id="reject_remark" name="reject_remark"> </textarea></td>
</tr>
