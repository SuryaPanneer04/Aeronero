...
<tr>
<td>POSITION:</td>
<td colspan="2"><input type="text" class="form-control" id="position" name="position" value="<?php echo  $row['tittle'];?>"readonly></td>
<!--td>Department:</td>
...
<script>
 ...
 function feedback_update1()
   ...
   alert(get_ids);
    ...
    $.ajax({
    type:'GET',
    data: data + "&" + "id="+id+"&candidate_id="+candidate_id,
	
    url:'qvision/interview_feedback/final_technical_update.php',
    success:function(data)
    {
      if(data==0)
      { 
