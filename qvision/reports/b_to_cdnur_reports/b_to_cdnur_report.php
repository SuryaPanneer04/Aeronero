...
.card-primary:not(.card-outline)>.card-header{
	...
	<div class="col-lg-12">
	<h4>B2CDNUR REPORT</h4>
	</div>
    <div class="panel-body">
	<form method="GET" name="b_to_cdnur_reports" role="form">
	...
	<div class="row">	
		...
		<div class="col-lg-3">
		<div class="form-group">
		    <input type="month" name="b_to_cdnurmonth" class="form-control" required>  
		</div>
		</div>
		
		<div class="col-lg-2">
		<div class="form-group">		
		<input  type="button" class="btn btn-default" value="search" onclick="b_to_cdnur_empview()">
		</div>
		</div>
  ...
  <!-- /.card-header -->
    <div class="card-body">
      <div id="b_to_cdnur_details_view">
      </div>
    </div>
...
function b_to_cdnur_empview()
{
	var data = $('form').serialize();
	$.ajax({
	type: "GET",
	url: "/ssinfo1/qvision/reports/b_to_cdnur_reports/b_to_cdnur_report_empview.php",
	data: data,
	success: function(data)
	{
	$("#b_to_cdnur_details_view").html(data);		
	}				
	});	
}
</script>