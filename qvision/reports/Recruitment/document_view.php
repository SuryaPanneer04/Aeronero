...
$sql=$con->query("select c.*,dm.designation_name from candidate_form_details c LEFT JOIN designation_master dm ON c.position = dm.id where c.id='$candidateid'");
$data=$sql->fetch();

$sql2=$con->query("select * from emp_personal_details where emp_id='$candidateid' && status=1 ");
$sts=$sql2->fetch();
...
<li class="nav-item"><input type="button" name="back" id="back" data-toggle="tab" class="btn btn-danger" value="Back" onclick="to_doc_view()"></li>
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="5"><input type="text" class="form-control" id="position" name="position" value="<?php echo $data['designation_name'];?>" readonly ></td>
        </tr>
        <tr>
        ...
        <td colspan="5"><input type="text" class="form-control" id="candidate_name" name="candidate_name" value="<?php echo $sts['name'];?>" readonly></td>
        </tr>
        <tr>
        <td>Father's Name:</td>
        <td colspan="5"><input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo $sts['fathers_name'];?>" readonly ></td>
        </tr>
        <tr>
        <td>Date of Birth:</td>
        <td colspan="5"><input type="date" class="form-control" id="dob" name="dob" value="<?php echo $sts['DOB'];?>" readonly></td>
        </tr>
        <tr>
        <td>Address Communication:</td>
        <td colspan="5"><input type="text" class="form-control" id="address" name="address" value="<?php echo $sts['communication_address'];?>" readonly ></td>
        </tr>
        <tr>
        <td>Permanent Address:</td>
        <td colspan="5"><input type="text" class="form-control" id="paddress" name="paddress" value="<?php echo $sts['permanent_address'];?>" readonly></td>
        </tr>
        <tr>
        <td>Telephone no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="phone" name="phone" value="<?php echo $sts['mobile_num'];?>" readonly></td>
        </tr>
        <tr>
        <td>Category (Email ID if any):</td>
        <td colspan="5"><input type="text" class="form-control" id="mail" name="mail" value="<?php echo $sts['email_id'];?>" readonly></td>
        </tr>
        <tr>
        <td>Aadhar Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="adharnumber" name="adharnumber" value="<?php echo $sts['aadhar_num'];?>" readonly></td>
        </tr>
        <tr>
        <td>Pan Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="pannumber" name="pannumber" value="<?php echo $sts['pan_num'];?>"readonly></td>
        </tr>
        <tr>
        <td>Voter ID:</td>
        <td colspan="4"><input type="text" class="form-control" id="voternumber" name="voternumber" value="<?php echo $sts['Voter_no'];?>" readonly></td>
        </tr>
        <tr>
        <td>Contact Person name:</td>
        <td colspan="5">
		<input type="text" class="form-control" id="cpn" name="cpn" value="<?php echo $sts['contact_person'];?>" readonly>
       </td>
        </tr>
         <tr>
        <td>Contact Person Relationship:</td>
        <td colspan="5">
		<input type="text" class="form-control" id="cpr" name="cpr" value="<?php echo $sts['emergency_contact_relationship'];?>" readonly>
       </td>
        </tr>
         <tr>
        <td>Contact Person Mobile.NO:</td>
        <td colspan="5">
		<input type="text" class="form-control" id="cpm" name="cpm" value="<?php echo $sts['emergency_num'];?>" readonly>
      </td>
        </tr>
...
<?php 
$sel=$con->query("select * from emp_qualification where emp_id='$candidateid' && status=1");
...
?>
    ...
    <tr>
      ...
      <td><a href="qvision/Recruitment/uploads/<?php echo $row['attachment']; ?>" download="<?php echo $row['attachment']; ?>"><?php echo $row['attachment']; ?></a></td>
   ...
   $i++;
	...
	<?php 
	$cer=$con->query("select * from emp_certification where emp_id='$candidateid' && status=1");
	?>
   <div class="tab-pane" id="certification_details">
    ...
    <tr>
     ...
     <td><input type="text" class="form-control" id="certifcatename_1" name="certifcatename[]" value="<?php echo $dis['certification_name']; ?>" readonly></td>
      ...
      <td><a href="qvision/Recruitment/uploads/<?php echo $dis['attachment']; ?>" download="<?php echo $dis['attachment']; ?>"><?php echo $dis['attachment']; ?></a></td>
    </tr>  
<?php
$i++;
	}
...
<?php } else { ?>
   ...
   // echo "select * from emp_exp_detail where emp_id='$candidateid'";
		...
		$totalexp=0;
		$i=1;
	while($edetail=$detail->fetch(PDO::FETCH_ASSOC))
	{
