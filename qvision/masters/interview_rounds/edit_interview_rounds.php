...
<div class="card card-primary">
  <div class="card-header">
    <center>
      <h3 class="card-title"><b>Intrerview Round </b></h3>
    </center>
  ...
  <form role="form" name="" action="" method="post" enctype="multipart/type">
    <table class="table table-bordered">
      ...
      <table class="table table-bordered">
        <h3>
          <center>Interview Feedback</center>
        </h3>
        <tbody>
...
where interview_rounds.id='$id'");
    ...
    <input type="button" class="btn btn-success btn-md" style="float:right;" name="Update" onclick="round_update()" value="Update">
...
<script>
  function round_update() {
    ...
    $.ajax({
      ...
      url: 'qvision/masters/interview_rounds/update_interview_rounds.php',
