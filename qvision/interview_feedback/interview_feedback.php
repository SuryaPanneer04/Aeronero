...
<div>
<input type="button" style="float:right;" class="btn btn-primary" name="print" onclick="printDiv('printableArea')"  value="Print">
<a onclick="return backtonew()" style="float:right;" data-toggle="modal" class="btn btn-primary"><i class="fa fa-minus"></i>Back</a>
</div>
</div>

<div class="card-body" id="printableArea">

<?php if($userrole=='R002') { ?>	
<form method="POST" action="/KerliERP/interview_feedback/newinterview_submit.php">
...
<td colspan="5">
<select class="form-control" id="replacement" name="replacement" onchange="candidate_replacess(this.value)">
...
<tr>
<td>POSITION:</td>
<td colspan="5"><input type="text" class="form-control" id="position" name="position" readonly></td>
</tr>

<tr>
<td>Type:</td>
<td colspan="5">
<select class="form-control" id="replacement" name="replacement" onchange="change()">
...
<tr>
<td>Notice period</td>
<td colspan="5"><input type="text" class="form-control" id="notice_period" name="notice_period"></td>
</tr>
...
<tr>
<td>POSITION:</td>
<td colspan="5"><input type="text" class="form-control" name="sposition" id="sposition" readonly="true"></td>
</tr>
<tr id="new_replace">
<td>candidate:</td>
...
<tr id="old_replace">
<td>Candidate Name:</td>
<td colspan="2"><input type="text" readonly="true" class="form-control" id="snew_name" name="snew_name" ></td>
<td>Replaced Candidate Name:</td>
...
<script>
	function backtonew()
	{
		$.ajax({
		type:"POST",
		url:"interview_feedback/new.php",
		success:function(data){
